from app.tasks.celery_app import celery_app  # ✅ no circular import
from app.services.pipeline import process_answer_sheet_sync
from app.core.logger import get_logger
from app.services.idempotency_service import (
    is_task_processed, mark_task_processed, redis_client
)
...
@celery_app.task(
    ...
    name="app.tasks.tasks.process_answer_sheet_task",  # ✅ fixed name
)
