...
/**
 * Represents a student's complete exam submission (e.g., a scanned PDF). Tracks
 * the overall OCR processing status, total marks awarded after evaluation, and
 * identifies both the student and the uploader.
 *
...
public class AnswersheetEntity {
    ...
    /**
     * OCR status to check is OCR done or pending of the answer sheet default is
     * pending
     */
    @Builder.Default
    ...
    /**
     * Evaluation status of the answersheet after the OCR done default pending
     */
    @Builder.Default
    ...
    /**
     * This relation for between exam and the answersheet where one exam have
     * multiple answersheets
     */
    @ManyToOne
    ...
    /**
     * This relation for between user and the answersheet where one student have
     * multiple answersheets
     */
    @ManyToOne
